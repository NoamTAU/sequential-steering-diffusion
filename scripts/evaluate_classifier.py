...
def create_argparser():
    defaults = dict(
        ...
        starting_data_dir="/work/pcsl/Noam/diffusion_datasets/selected_images",
        data_dir=os.path.join(os.getcwd(), "results", "/home/nlevi/Noam/SingleMaskDiffusion/guided-diffusion/scripts/results/forw_back_uncond/2025-12-18-14-12-37-321303"),
